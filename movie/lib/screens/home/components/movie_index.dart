...
import 'package:movie/screens/details/detail_screen.dart';
import 'package:movie/widget/genres_format.dart';
import 'package:movie/widget/star_rating.dart';
        ...
        children: <Widget>[
          ...
          Container(
            ...
            child: Align(
              ...
              child: Image.asset(
                movieData.movieList[widget.index].imageLogo,
          ...
          GestureDetector(
            ...
            child: ClipRRect(
              ...
              child: Image.asset(
                 movieData.movieList[widget.index].image,
